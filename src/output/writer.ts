...
/**
 * Footer appended to every review document. Shared with the verifier, which
 * subtracts it from section-body measurements.
 */
export const REVIEW_FOOTER = "*Generated by second-opinion MCP server*";
 ...
 */
export function generateBaseFilename(metadata: ReviewMetadata): string {
...
/**
 * Write the self-contained prompt document used by a handoff reviewer.
 */
export function writePromptFile(
  ...
  const filePath = path.join(
    outputDirPath,
    `${generateBaseFilename(metadata)}.prompt.md`
  );
