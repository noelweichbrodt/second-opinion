...
- `templates/second-opinion.md` is the single methodology source. The installer skips existing targets — after editing it, re-sync `~/.config/second-opinion/second-opinion.md` and verify with `cmp`.
