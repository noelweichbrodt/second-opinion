...
- Findings are written for the change's author. *Writing for the Author* in the template governs reviewer output and the consensus synthesis alike; triage vocabulary (altitude, rung, reachability) never appears in a finding.
